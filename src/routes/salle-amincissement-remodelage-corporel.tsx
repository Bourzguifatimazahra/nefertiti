...
export const Route = createFileRoute("/salle-amincissement-remodelage-corporel")({
  head: () => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: canonicalUrl("/salle-amincissement-remodelage-corporel") },
        { property: "og:image", content: deptImages[0] },
      ],
      links: [{ rel: "canonical", href: canonicalUrl("/salle-amincissement-remodelage-corporel") }],
    };
  },
  component: () => {
    const { t } = useI18n();
    return (
      <>
        ...
        <DepartmentPage
          ...
          title={t("dept.salleAmincissement.title")}
