...
export const Route = createFileRoute("/salle-injections-medecine-esthetique")({
  head: () => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: canonicalUrl("/salle-injections-medecine-esthetique") },
        { property: "og:image", content: equipImages[0] },
      ],
      links: [{ rel: "canonical", href: canonicalUrl("/salle-injections-medecine-esthetique") }],
    };
  },
  component: () => {
    const { t } = useI18n();
    return (
      <>
        ...
        <DepartmentPage
          ...
          title={t("dept.salleInjections.title")}
